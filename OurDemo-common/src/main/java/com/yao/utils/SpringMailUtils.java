	...
	public static String sendMail(String toMailUrl,String username,String activeCode) throws MessagingException {
        ...
        messageHelper  
                .setText("<html><head></head><body><pre>亲爱的用户"+username+"：您好！"+
                		...
                		"<br/><a href='http://localhost:8888/OurDemo/register.do?username="+username+"&amp;activeCode="+activeCode+"'>"+
                		"http://localhost:8888/OurDemo/register.do?username="+username+"&amp;activeCode="+activeCode+"</a>"+
                		...
                		"<br/>重新发送激活码：http://localhost:8888/OurDemo/toregister.do?action=resendActiveEmail&amp;username="+username+
                		"</pre></body></html>",  
                        true);  
